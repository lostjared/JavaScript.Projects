...
void procEvent() {
        ...
        SDL_Rect rc1 = { 25, 25, display_cords[index1].w, display_cords[index1].h};
        SDL_RenderCopy(ren, display_textures[index1], 0, &rc1);
        ...
        if(show_win) {
            ...
            SDL_Rect rc1 = { 25, 70, display_cords[index2].w, display_cords[index2].h };
            SDL_RenderCopy(ren, display_textures[index2], 0, &rc1);
...
int main(int argc, char **argv) {
    ...
    surface = SDL_CreateRGBSurfaceFrom(NULL, Width, Height, 32, 0, 0x00FF0000, 0x0000FF00,0x000000FF,0xFF000000);

   
    emscripten_set_main_loop(procEvent, 0, 1);
...
void initTextures() {
    ...
    SDL_Surface *cardb = SDL_LoadBMP("/assets/cardback.bmp"), *carda = SDL_LoadBMP("/assets/cardace.bmp"), *cardk = SDL_LoadBMP("/assets/cardking.bmp");
