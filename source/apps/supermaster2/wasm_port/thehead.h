...
inline void draw()
	{
		...
		img[0].DisplayGraphic(100,100);
		img[1].DisplayGraphic(450,270);
		...
		case ID_ABOUTSCREEN:
			{
				mxhwnd.paint.mxdrawrect(10,170,630,450,0x0,0x0);
...
private:
	...
	inline void draw()
	{
		...
		mxhwnd.text.sprinttext(20,180," Now Entering Level (%d) - press enter key to continue",cur_level);
		ehero.DisplayGraphic(200,250);
		mxhwnd.text.sprinttext(200+36+5,250," Lives: %i",lives);
		mxhwnd.text.sprinttext(200+36+5,270," Kills: %i",kills);
		mxhwnd.text.sprinttext(200+36+5,290," Score: %i",score);
